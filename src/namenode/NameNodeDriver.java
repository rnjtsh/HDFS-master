...
public class NameNodeDriver implements NameNode {
    ...
    public BlockReport.BlockReportResponse updateBlockInfo(BlockReport.BlockReportRequest br) {
        ...
        try{
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "Something went wrong "
    ...
    public HeartBeat.HeartBeatResponse sendHeartBeat(HeartBeat.HeartBeatRequest hb) {
        ...
        try{
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,"Could not get host ip"
    ...
    public ClientNameNode.OpenFileResponse openFile(ClientNameNode.OpenFileRequest op) {
        ...
        try {
            ...
            if(mode == 0) //Write
            {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.INFO,"Received request for"
            ...
            else if (mode == 1) //Read
            {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.INFO,"Something seems to be"
    ...
    public ClientNameNode.CloseFileResponse closeFile(ClientNameNode.CloseFileRequest cl) {
        ...
        try{
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "Something wrong happened"
